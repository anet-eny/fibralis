        ...
        <div className="mb-12 grid grid-cols-1 items-end gap-8 lg:mb-16 lg:grid-cols-2 lg:gap-x-20">
          <div className="min-w-0">
            ...
            <p className="text-base font-light leading-[1.8] text-muted">
              Every Fibralis molecule starts not from an existing ingredient but
              from a design brief: a target receptor, a documented active site,
              and a set of production constraints. Using structure-prediction
              tools (AlphaFold2, ESMFold), molecular dynamics simulations, and
              charge-pair interaction modelling, we build sequences{" "}
              <em className="italic text-cream/75">de novo</em> — retaining the
              receptor-binding geometry confirmed in literature while
              introducing modifications that make the molecule expressible in{" "}
              <em className="italic text-cream/75">E. coli</em> at useful yield
              and purity. Rosetta-based fixedbb design and ProteinMPNN allow us
              to explore sequence variants that preserve the active site
              scaffold while optimising surface properties for solubility and
              stability. The outcome is a molecule whose bioactivity is anchored
              in established collagen biology, but whose exact sequence is an
              engineering decision rather than a natural accident.
            </p>
          </div>
