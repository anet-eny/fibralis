  ...
  return (
    <section className="border-b border-border bg-surface py-section">
      <Reveal className="container">
        <div className="grid grid-cols-1 items-start gap-10 md:grid-cols-[280px_1fr] md:gap-24">
          <div className="pt-1">
          ...
          <div className="space-y-6">
            <p className={sectionBody}>
              ...
              missing is a systematic way to take those sequences — most of
              which were characterised in the context of native, animal-derived
              collagen — and re-engineer them into molecules that can be
              produced recombinantly, at defined purity, without batch-to-batch
              variability and without animal sourcing.
            </p>
            <p className={sectionBody}>
              ...
              rather than through enzymatic co-expression; structural
              constraints specific to each molecule class — whether
              triple-helix nucleation, β-turn conformation, or palmitoylation
              geometry — are addressed in silico before synthesis. The result is
              a pipeline of defined, reproducible molecules whose bioactivity is
              grounded in the same receptor biology that the broader field has
              spent decades characterising.
            </p>
          </div>
        </div>
      </Reveal>
